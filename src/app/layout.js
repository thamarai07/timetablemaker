...
export const metadata = {
  ...
  description: "Create, manage, and customize your timetable with ease using our intuitive timetable maker.",
  keywords: "timetable maker, create timetable, manage timetable, student timetable, teacher timetable",
  ...
  return (
    <html lang="en">
      <Head>
        ...
        <meta name="twitter:image" content="/path-to-image.jpg" /> {/* Add your image URL */}
